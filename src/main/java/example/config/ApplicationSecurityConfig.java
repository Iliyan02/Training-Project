...
import example.service.impl.SongDBUserService;
...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public ApplicationSecurityConfig(SongDBUserService movieDBUserService, PasswordEncoder passwordEncoder) {
        this.songDBUserService = movieDBUserService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.
                ...
                // allow access to index, user login and registration to anyone
                        antMatchers("/", "/users/login", "/users/register", "/policy/privacyPolicy", "/policy/aboutUs").permitAll().
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.
                userDetailsService(songDBUserService).
